...
CRP = 'DISPLAY= /opt/google/chrome-remote-desktop/start-host --code="4/0Adeu5BWnbu_v2dyUFeeiBzXtm_DGGWxNS1YVb0ktlmNy0uCgQnGGXUwK_yjlHD2Za-8sGA" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$(hostname)' #@param {type:"string"}
